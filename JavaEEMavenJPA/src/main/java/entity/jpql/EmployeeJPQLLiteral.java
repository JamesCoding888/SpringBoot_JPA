...
@Entity
@Table(name = "employee_jpql_literal")
public class EmployeeJPQLLiteral {
	...
	public EmployeeJPQLLiteral() {
		
	}

	
	public EmployeeJPQLLiteral(String name, Role role, Integer salary, Date date, Boolean valid) {
		this.name = name;
		this.role = role;
		this.salary = salary;
		this.date = date;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EmployeeJPQLLiteral other = (EmployeeJPQLLiteral) obj;
